...
export default function Clientes() {
    ...
    const mostrar = () => {
        ...
        axios.get("http://localhost:8080/cliente/Consulta")
    ...
    const registro = () => {
        ...
        console.log(body)
        if(curp.length > 15 ){
            axios.post("http://localhost:8080/cliente/registrar", body)
            .catch((err) => { err })
    ...
    const editar = () => {
        ...
        axios.put(`http://localhost:8080/cliente/actualizar/${idd}`, body)
            .then(()=> mostrar())
            .catch((err) => console.log(err))
